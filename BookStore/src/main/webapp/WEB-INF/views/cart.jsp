							...
							<td data-th="Product">
								<div class="row">
									...
									<div class="col-sm-10">
										...
										<p><strong>Author</strong> - ${cartLine.product.author}</p>
										<p><strong>Description</strong> - ${cartLine.product.description}</p>
									</div>
								</div>
							</td>
							<td data-th="Price">&#36; ${cartLine.buyingPrice}</td>
							<td data-th="Quantity"><input type="number" id="count_${cartLine.id}" min="1" max="3" class="form-control text-center" value="${cartLine.productCount}"></td>
